...
using BLL.Models.Requests.Morphology;
using BLL.Models.Respone.Morphology;

namespace BLL.Services.Morphology
{
    public class HebrewMorphology
    {
        ...
        {
            var t=Analyzer.GetService<List<List<MorphInfo>>>(new AnalyzeRequest() { sentence = sentence });
            return t;
        }
