...
namespace BLL
{
  ...
  public class Improveement
  {
    ...
    /// <param name="y"></param>
    /// <returns></returns>
    public List<int> StartingIndexString(string[] x, string[] y, Ballad120Entities ent)
    {
    ...
    /// <param name="y"></param>
    /// <returns></returns>
    public List<int> getStartingIndexesString(string[] x, string[] y, Ballad120Entities ent)
    {
    ...
    /// <returns></returns>
    public RequestResult getMatchSongs(string text, Ballad120Entities ent, int usrId = 0, string state = "")
    {
      try
      {
        if (usrId == 0)
    ...
    public RequestResult improveementTags(string text, int songId, Ballad120Entities ent)
    {
      try
      {
        //הסרת רווחים מיותרים
        ...
        foreach (List<WordInform> wordInform in matchTags)
        {
          ...
          {
            newTag = String.Concat(newTag, wi.Word, " ");
           //שרשור מילות התגית אל התגית החדשה
          }
        }
              ...
              if (matchTags[0][0].SongIndex < songTagsInform[0].Count) //ראשון = הטקסט הנדרש באיתור, שייך (לפחות לסוף ) תגית ראשונה בשיר המקור.
              {
                if (matchTags[matchTags.Count - 1][0].SongIndex == songTagsInform[songTagsInform.Count - 1][0].SongIndex)//אחרון = הטקסט הנדרש באיתור, שייך (לפחות לתחילת התגית ) לתגית האחרונה בשיר המקור.
                {
...

                  {
                    ...
                    for (int l = (matchTags[matchTags.Count - 1].Count - 1 + 1); l < songTagsInform[songTagsInform.Count - 1].Count; l++)//התגית האחרונה המורכבת מהמילה הבאה ואילך
                    {
                      ...
                      newNextTag = String.Concat(newNextTag , songTagsInform[songTagsInform.Count - 1][l].Word , " ");
                    }
                ...
                else   //לא אחרון = הטקסט הנדרש באיתור, לא  שייך (לפחות לתחילת התגית) לתגית האחרונה בשיר המקור.
                {
...

                  {
                    ...
                    {
                      newNextTag = String.Concat(newNextTag , songTagsInform[ll][l].Word, " ");
                    }
                    newNextTag = newNextTag.Substring(0, newNextTag.Length - 1);//הסרת הרווח האחרון
                  ...
                  else//נותרה מילה אחת כולל המילה הזו
                  {
                    ...
                    newNextNewTag = String.Concat(newNextNewTag , " " , songTagsInform[ll][songTagsInform[ll].Count - 1].Word);


                    ll++;
                    for (int l = 0; l < songTagsInform[ll].Count; l++)
                    {
                      newNextNewTag = String.Concat(newNextNewTag , " " , songTagsInform[ll][l].Word);
                    }
              ...
              else  //לא ראשון = הטקסט הנדרש באיתור, לא שייך(לפחות לסוף) תגית ראשונה בשיר המקור.
              {
                if (matchTags[matchTags.Count - 1][0].SongIndex == songTagsInform[songTagsInform.Count - 1][0].SongIndex) //אחרון = הטקסט הנדרש באיתור, שייך (לפחות לתחילת התגית ) לתגית האחרונה בשיר המקור.
                {
                  ...
                  else//נותרה מילה אחת כולל המילה הזו
                  {
                    ...
                    int areaNewTag = startLine;//המיקום אליו תכנס התגית החדשה
                    text = String.Concat(text , " " , songContectSplit[songContectSplit.Length - 1]);
                    ent.Tags.Where(p => p.songId == songId).OrderBy(q => q.tagId).ToList()[areaNewTag].tagName = text;//הכנסת התגית החדשה
              ...
              if (matchTags[0][0].SongIndex < songTagsInform[0].Count) //ראשון = הטקסט הנדרש באיתור, שייך (לפחות לסוף ) תגית ראשונה בשיר המקור.
              {
                if (matchTags[matchTags.Count - 1][0].SongIndex == songTagsInform[songTagsInform.Count - 1][0].SongIndex)//אחרון = הטקסט הנדרש באיתור, שייך (לפחות לתחילת התגית ) לתגית האחרונה בשיר המקור.
                {
                  ...
                  if (difference != 1)//מספר המילים מתחילת השיר עד תחילת תוכן האיתור, גדול מ1
                  {
                    ...
                    {
                      newTagFirst = String.Concat(newTagFirst , songContectSplit[l] , " ");
                    }
                ...
                else   //לא אחרון = הטקסט הנדרש באיתור, לא  שייך(לפחות לתחילת התגית) לתגית האחרונה בשיר המקור.
                {
                  ...
                  {
                    string newTagit = String.Concat(songContectSplit[0] , " " , text);
              ...
              else  //לא ראשון = הטקסט הנדרש באיתור, לא שייך(לפחות לסוף) תגית ראשונה בשיר המקור
              {
                if (matchTags[matchTags.Count - 1][0].SongIndex == songTagsInform[songTagsInform.Count - 1][0].SongIndex) //אחרון = הטקסט הנדרש באיתור, שייך (לפחות לתחילת התגית ) לתגית האחרונה בשיר המקור.
                {
                  ...
                  if (difference != 1)//מספר המילים מתחילת השיר עד תחילת תוכן האיתור, גדול מ1
                  {
                    ...
                    {
                      newTagFirst = String.Concat(newTagFirst , songTagsInform[matchTags[0][0].TagIndex][l].Word , " ");
                    }
                    newTagFirst = newTagFirst.Substring(0, newTagFirst.Length - 1);
                  ...
                  else
                  {
                    ...
                    newBackTag = String.Concat(newBackTag , " " , songTagsInform[matchTags[0][0].TagIndex][0].Word);
                ...
                if (matchTags[matchTags.Count - 1][0].SongIndex == songTagsInform[songTagsInform.Count - 1][0].SongIndex)//אחרון = הטקסט הנדרש באיתור, שייך (לפחות לתחילת התגית ) לתגית האחרונה בשיר המקור.
                {
                  ...
                  if (difference != 1)//מספר המילים מתחילת השיר עד תחילת תוכן האיתור, גדול מ1
                  {
                    if (matchTags[matchTags.Count - 1][(matchTags[matchTags.Count - 1].Count - 1)].SongIndex + 1 < songTagsInform[(matchTags[matchTags.Count - 1][(matchTags[matchTags.Count - 1].Count - 1)].TagIndex)][(songTagsInform[(matchTags[matchTags.Count - 1][(matchTags[matchTags.Count - 1].Count - 1)].TagIndex)].Count - 1)].SongIndex)// נותרה יותר ממילה אחת עד סוף התגית
                    {
                      ...
                      {
                        newPrevTag= String.Concat(newPrevTag,songTagsInform[matchTags[0][0].TagIndex][l].Word , " ");
                      }
                      ...
                      {
                        newNextTag= String.Concat(newNextTag, songTagsInform[matchTags[matchTags.Count - 1][0].TagIndex][thisCount + l].Word + " ");
                      }
                    ...
                    else// נותרה מילה אחת עד סיום התגית
                    {
                      ...
                      {
                        newPrevTag= String.Concat(newPrevTag, songTagsInform[matchTags[0][0].TagIndex][l].Word , " ");//שרשור
                      }
                      ...
                      newCurrentTag = String.Concat(newCurrentTag , " " ,endCurrentTag);
                  ...
                  else//
                  {
                    if (matchTags[matchTags.Count - 1][(matchTags[matchTags.Count - 1].Count - 1)].SongIndex + 1 < songTagsInform[(matchTags[matchTags.Count - 1][(matchTags[matchTags.Count - 1].Count - 1)].TagIndex)][(songTagsInform[(matchTags[matchTags.Count - 1][(matchTags[matchTags.Count - 1].Count - 1)].TagIndex)].Count - 1)].SongIndex)// נותרה יותר ממילה אחת עד סוף התגית
                    {
                      ...
                      string newNextTag = "";//תגית הבאה
                      newCurrentTag = text;//תוכן תיבת הטקסט בשלמות
                      newCurrentTag = String.Concat(songTagsInform[matchTags[0][0].TagIndex][0].Word , " " , text);
                      int baseCount = songTagsInform[matchTags[matchTags.Count - 1][0].TagIndex].Count;//מספר המילים בתגית האחרונה ממנה לקוח תוכן תיבת הטקסט
                      int thisCount = matchTags[matchTags.Count - 1].Count;//מספר המילים בתגית האחרונה שהוקלדו בתיבת האתור
                      int times = baseCount - thisCount;//נניח שלוש פחות אחד, מספר המילים בסוף התגית שיש לסרוק
                      for (int l = 0; l < times; l++)//תחילת התגית הבאה החדשה
                ...
                else   //לא אחרון = הטקסט הנדרש באיתור, לא  שייך (לפחות לתחילת התגית) לתגית האחרונה בשיר המקור.
                {
                  ...
                  if (difference != 1)//מספר המילים מתחילת השיר עד תחילת תוכן האיתור, גדול מ1
                  {
                    ...
                    else// נותרה מילה אחת עד סיום התגית
                    {
                      ...
                      newNextTag = String.Concat(d , " " , nextNextTag1);//לכידה כאמור לתגית הבאה
                  ...
                  else
                  {
                    ...
                    else// נותרה מילה אחת עד סיום התגית
                    {
                      ...
                      for (int l = 0; l < times; l++)//תחילת התגית הבאה החדשה
                      {
                        newNextTag = String.Concat(newNextTag,songTagsInform[matchTags[matchTags.Count - 1][0].TagIndex + 1][l].Word , " ");
                      }
                      newNextTag = String.Concat(songTagsInform[matchTags[matchTags.Count - 1][0].TagIndex][(songTagsInform[matchTags[matchTags.Count - 1][0].TagIndex].Count) - 1].Word , " " , newNextTag);
                ...
                if (matchTags[matchTags.Count - 1][0].SongIndex == songTagsInform[songTagsInform.Count - 1][0].SongIndex) //אחרון = הטקסט הנדרש באיתור, שייך (לפחות לתחילת התגית ) לתגית האחרונה בשיר המקור.
                {
                  ...
                  if (difference != 1)
                  {
                    ...
                    else// נותרה מילה אחת עד סיום התגית
                    {
                      ...
                      newCurrentTag = String.Concat(newCurrentTag , " " , d);
                  ...
                  else
                  {
                    ...
                    if (matchTags[matchTags.Count - 1][(matchTags[matchTags.Count - 1].Count - 1)].SongIndex + 1 < songTagsInform[(matchTags[matchTags.Count - 1][(matchTags[matchTags.Count - 1].Count - 1)].TagIndex)][(songTagsInform[(matchTags[matchTags.Count - 1][(matchTags[matchTags.Count - 1].Count - 1)].TagIndex)].Count - 1)].SongIndex)// נותרה יותר ממילה אחת עד סוף התגית
                    {
                      ...
                      {
                        beginPrevTag = String.Concat(beginPrevTag,songTagsInform[matchTags[0][0].TagIndex - 1][l].Word , " ");
                      }
                      beginPrevTag = beginPrevTag.Substring(0, beginPrevTag.Length - 1);
                      newPrevTag = String.Concat(beginPrevTag , " " , songTagsInform[matchTags[0][0].TagIndex][0].Word);
                    ...
                    else// נותרה מילה אחת עד סיום התגית
                    {
                      ...
                      for (int l = 0; l < songTagsInform[matchTags[0][0].TagIndex - 1].Count; l++)//כל מילות התגית הקודמת החדשה, שהיא תחילת התגית הנוכחית עד תיבת הטקסט
                      {
                        v= String.Concat(v,songTagsInform[matchTags[0][0].TagIndex - 1][l].Word , " ");
                      }
                      v = v.Substring(0, v.Length - 1);
                      newPrevTag = String.Concat(v , " " , songTagsInform[matchTags[0][0].TagIndex][0].Word);
                      string lastWord = "";
                      ...
                      newCurrentTag = String.Concat(newCurrentTag , " " , lastWord);
                ...
                else   //לא אחרון = הטקסט הנדרש באיתור, לא  שייך (לפחות לתחילת התגית) לתגית האחרונה בשיר המקור.
                {
                  ...
                  if (difference != 1)//מספר המילים מתחילת השיר עד תחילת תוכן האיתור, גדול מ1
                  {
                    ...
                    else// נותרה מילה אחת עד סיום התגית
                    {
                      ...
                      newNextTag = String.Concat(beginNextTag , " " , nextNextTag1);//לכידה כאמור לתגית הבאה
