...
namespace BLL
{
  ...
  public class AnalyzingToTags
  {
    ...
    private static List<string> betoch = new List<string> { "בתוככם", "בתוככן", "בתוכם", "בתוכן", "בתוך", "בתוכי", "בתוכך", "בתוכך", "בתוכו", "בתוכה", "בתוכנו" /*9+1*/};// 
    ...
    public List<List<string>> canStart_1_1p_19 = new List<List<string>> { betoch, leyad, ani, legabey, question, startss, middleStart };//מילים שיכולות לפתח ולא חיבות
    public List<List<string>> canEnd_9_9p_19 = new List<List<string>> { achar, el, ezel, et, tachat, bishvil, meachor, shel, lefanay, be, bein, me, lach, leyad, bilad, betoch, middleEnd };//מילים שיכולות לסגר ולא חייבות
    ...
    public List<List<string>> start_ = new List<List<string>> { startss, ani, legabey, question };//מילים חיבות להיות בהתחלה
    ...
    public List<Tag> joinTagForward(List<Tag> LTags, int index)
    {
      ...
      LTags[index].FullTag = String.Concat(LTags[index].FullTag, " ", LTags[index + 1].FullTag);//שרשור התגית הבאה לתגית הזו
    ...
    {
      LTags[index].FullTag = String.Concat(LTags[index - 1].FullTag, " ", LTags[index].FullTag, " ", LTags[index + 1].FullTag);//השמת שרשור התגית הקודמת, הנוכחית והבאה לתגית הנוכחית
...

    {
      ...
      LTags[index].FullTag = String.Concat(LTags[index - 1].FullTag, " ", LTags[index].FullTag);//שרשור תגית נוכחית לתגית הקודמת
